...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BmJv61CT.js
...
var styles_default = "/assets/styles-Cwx-eojF.css";
var APP_NAME = "The Wedding of Rizal & Farah";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Kamis, 15 Oktober 2026 · Gedung Aula SMADA Situbondo"
			},
			{
				name: "theme-color",
				content: "#6B1525"
...
var $$splitComponentImporter = () => import("./routes-z3XbfVpY.mjs");
